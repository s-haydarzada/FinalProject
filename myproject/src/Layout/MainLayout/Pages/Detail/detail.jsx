...
fetchData()
  ...
  const { images, title, description, productPrice } = singleItem;
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center">
          <motion.div variants={fadeIn("down", 0.2)} initial="hidden" whileInView={"show"} viewport={{once:false,amount:0.7}}>
            ...
            <img className="max-w-[100px] scale-75 hover:scale-100 duration-700 overflow-clip lg:max-w-sm" src={firstImage.url} alt="" />
          </div>
          </motion.div>
